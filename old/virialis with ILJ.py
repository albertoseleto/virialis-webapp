...
data = pd.read_csv('F2F2-ilj_SAPT2.dat', sep="\s+", header=None)
data.columns = ["alfa", "beta", "mp", "Req", 'De']
...
class H: 
    ...
    alfa = data.loc[0,'alfa']
    beta = data.loc[0,'beta']
    mp = data.loc[0,'mp'] 
    Req = data.loc[0,'Req'] 
    De = data.loc[0,'De']*0.0012398#********VALOR CORRETO VERIFICADO **********(0.002859/23.06055)#* 0.0012398 #(0.002859/23.06055) / 1.2398e-7

      
class X: 
    
    alfa = data.loc[1,'alfa']
    beta = data.loc[1,'beta']
    mp = data.loc[1,'mp']
    Req = data.loc[1,'Req'] 
    De = data.loc[1,'De']*0.0012398#(0.002859/23.06055)#* 0.12398 
       
class Z: 
    
    alfa = data.loc[2,'alfa']
    beta = data.loc[2,'beta']
    mp = data.loc[2,'mp']
    Req = data.loc[2,'Req']  
    De = data.loc[2,'De']*0.0012398#(0.002859/23.06055)#* 0.12398  
    
class Ta: 
    
    alfa = data.loc[3,'alfa']
    beta = data.loc[3,'beta']
    mp = data.loc[3,'mp']
    Req = data.loc[3,'Req'] 
    De = data.loc[3,'De']*0.0012398#(0.002859/23.06055)#* 0.12398 
    
class Tb: 
    
    alfa = data.loc[4,'alfa']
    beta = data.loc[4,'beta']
    mp = data.loc[4,'mp']
    Req = data.loc[4,'Req']
    De = data.loc[4,'De']*0.0012398#(0.002859/23.06055)#* 0.12398 
    

class L: 
    
    alfa = data.loc[5,'alfa']
    beta = data.loc[5,'beta']
    mp = data.loc[5,'mp']
    Req = data.loc[5,'Req']
    De = data.loc[5,'De']*0.0012398#(0.002859/23.06055)#* 0.12398 

class Sa: 
    
    alfa = data.loc[6,'alfa']
    beta = data.loc[6,'beta']
    mp = data.loc[6,'mp']
    Req = data.loc[6,'Req']
    De = data.loc[6,'De'] *0.0012398#(0.002859/23.06055) # * 0.12398 #

class Sb: 
    
    alfa = data.loc[7,'alfa']
    beta = data.loc[7,'beta']
    mp = data.loc[7,'mp']
    Req = data.loc[7,'Req']
    De = data.loc[7,'De']*0.0012398 #(0.002859/23.06055) # * 0.12398 #
...
while True:
    ...
    if molecula == 'H2F2':
        ...
        B_ref = [-50.13, -50.13, -33.91 ,-27.86 ,  -22.83 ,  -9.18,  -1.30,  4.70 , 8.49]  #errado, sao do h2f2
...
for T in range(50,1000,80):   
    ...
    print(T)
    print('result VEGAS class = ',result)
    print('result VEGAS c1 = ',result_c1)
    print('result VEGAS c2 = ',result_c2)
    print('result VEGAS c3 = ', result_c3)
    print('result VEGAS c4 =', result_c4)
