...
st.title('Second Virial Coefficient Calculator')
st.subheader('For the A2B2 Poliatomic Molecule')
...
if potential == 'both':
    uploaded_file = st.file_uploader("Upload a improved Lennard-Jonnes file with mev as the unit of energy")
    uploaded_file_2 = st.file_uploader("Upload the rydberg file with mev as the unit of energy")
        ...
        if potential == 'Improved Leonard-Jonnes Potential':
            ...
            if imported.data_ilj is not None and imported.data_ryd is not None:  # Check if data has been processed
                ...
                for temp in range(50, 1000, step):
                    ...
                    st.write('B_total =',B_main_values_ilj)
                #st.write('LC', stop_calc_instance - start)
