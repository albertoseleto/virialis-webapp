...
kb = 0.0019872041*1000# para kcal/mol, *1000 nao sei pq
...
#INPUT DAS MASSAS PARA O MI
        ...
        def trapezoidal_integration(func, a, b, n):
                ...
                :param n: The number of subintervals to divide the interval [a, b].
        ...
        a = 0
        b = 10
        n = 1000  # You can adjust the number of subintervals for accuracy

        

        #CALCULO DAS INTEGRAIS E COEFICIENTES VIRIAIS PARA DIFERENTES TEMPERATURAS
        for T in range(10, 1000, 20): #CALCULOS QUE SERÃO FEITOS NO PRIMEIRO INTERVALO DE TEMPERATURA
        
            result = trapezoidal_integration(fprincipal, a, b, n)
            print("Approximate Integral:", result)

            #print(integral, err3)
            B3=(2*np.pi*N_A)*(result+(R_0**3)/3) #coef do virial principal
